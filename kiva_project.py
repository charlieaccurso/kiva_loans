...
print("I would recommend Kiva to investigate reasons for the gender disparity in loan amounts awarded.")
...
print("Identify whether the larger loans issued to men correlate to positive outcomes, \
such as higher repayment reliability, higher return on investment, etc. If this is the \
case, reassess how women are being qualified for loans; are they being qualified fairly?")
...
# Add a title
ax.set_title("Average Loan Amount Awarded by Country")
...
print("Kenya's box has the widest distribution.")
...
print("You would be most likely to receive the largest loan amount in Cambodia.")
...
print("Farming activities are most likely to receive higher loan amounts.")
...
print("In three of the five countries, Pakistan, Kenya, and Cambodia, men tend to receive more high-value loans. For low-value loans, women in Kenya and the Philippines tend to receive more of them than their male counterparts.")
...
print("How amazing is Data Science?!!")
